...
public class AuthController {
    ...
    public ResponseEntity<SmsAuthSendResponseDto> smsAuth(
            @RequestBody @Valid SmsAuthRequestDto smsAuthRequestDto
    ) {
    ...
    public ResponseEntity<AuthVerifyResultDto> smsAuthVerify(
            @RequestBody @Valid SmsAuthVerifyRequestDto smsAuthVerifyRequestDto
    ) {
